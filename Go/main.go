...
// 		o.Insert(v)
// 	}
// 	UserSQL("doramaba-admin", "doramaba-password", 24, "男性", "愛知県", "学生", "oramaba-password", "/static/img/shijimi-transparence.png", "未婚", "A型")

// 	TvProgramSQL("お問い合わせ専用", "サービス改善のため、忌憚のないご意見・ご感想をお待ちしております。\n3回に1回くらい褒めていただけると幸いです。", "/static/img/shijimi-transparence.png", "", "", "", "大学院生です", "コメディ・パロディ", "松江育ち", "単独開発Help!!", "あああ", "shijimi", 2019, "秋", "milet", "金", 100, 2.5, 0, 0, 0)
// }

// func execSQL() {
// 	for i := 1; i < 5; i++ {
// 		TvProgramSQL("偽装不倫_"+strconv.Itoa(i), "濱鐘子は32歳で独身。周りからは「パラサイトシングル」や「婚活疲れした派遣社員」など不名誉なレッテルが貼られる始末。2年間の婚活も成就せず、自分はモテない女だと自覚するようになってしまう。「おひとり様」生活がしっくりくるようになり、1年間の派遣社員生活を終え、婚活に別れを告げるために1人旅をしようと計画する。 そんな中、1人旅をするために乗り込んだ飛行機の中で1人の若者に出会い、自分は「既婚者」だと言い様のない嘘を吐いてしまう。それでも若者は「この旅行の間だけでも不倫をしましょう」と迫ってきて、鐘子は恋の楽しさを覚える深みにはまっていく。", "https://www.ntv.co.jp/gisouhurin/images/ogp.jpg", "ntv", "https://www.youtube.com/embed/ARjBD23zFaQ", "7月期新水曜ドラマ『偽装不倫』7月10日（水）よる10時スタート／プロローグ［日本テレビ］", "杏、宮沢氷魚、谷原章介、仲間由紀恵", "恋愛、不倫、コメディ・パロディ", "衛藤凛", "", "鈴木勇馬、南雲聖一", "日テレ", 2019, "秋", "milet 「us」", "水", float32(i), 3, 0, 0, 0)
...
// 		}
// 		UserSQL("shuto"+strconv.Itoa(i), "password", 22, "男性", "愛知県", "学生", "乃木"+strconv.Itoa(i), "http://blog-imgs-34.fc2.com/m/i/n/minamijima/Mx1mTAr153j4wz96j8npWxBF_500.jpg", "未婚", "A型")
...
// 	// for i := 1; i < 3; i++ {
// 	// 	TvProgramSQL("Heaven? 〜ご苦楽レストラン〜_"+strconv.Itoa(i), "フレンチレストランで働いている伊賀観は、ある日ふとした事件がきっかけで黒須仮名子と出会う。黒須は新たにフレン。", "http://www.tbs.co.jp/Heaven_tbs/img/ogp02.jpg?58465464654", "tbs", "https://www.youtube.com/embed/6Wxy-Gr3VgM", "[新ドラマ]『Heaven?～ご苦楽レストラン～』7/9(火)スタート!! 石原さとみがフレンチレストランのオーナー役に!!【TBS】", "石原さとみ、福士蒼汰、志尊淳", "コメディ・パロディ、フレンチ", "吉田恵里香", "", "木村ひさし、松木彩、村尾嘉昭", "TBS", int(2019), "夏", "あいみょん 「真夏の夜の匂いがする」", "火", float32(i), float32(3), int32(0), int32(0), int32(0))
// 	// }
