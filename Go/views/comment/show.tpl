    ...
    <ons-dialog id="tweet_dialog" modifier="large" cancelable fullscreen>
      <ons-page>
        ...
        <div style="text-align:center;">
          <textarea class="textarea" rows="10" id="tweet_dialog_content" name="content" type="text" minlength="5" maxlength="250" required></textarea>
        </div>
        <div style="text-align:right;">あと<span class="count"></span>文字</div>
      </ons-page>
  ...
  <template id="search_dialog.html">
    <ons-dialog id="search_dialog" modifier="large" cancelable fullscreen>
      <ons-page>
        ...
        <div class="scroller">
          <form name="search_comment" id="search_comment" action="/tv/tv_program/comment/search_comment/{{.TvProgram.Id}}" method="post">
