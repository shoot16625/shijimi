    ...
    <form id="create_user" action="/tv/user/{{.User.Id}}" method="post">
      <div style="text-align: center; margin-top: 30px;">
        ...
        <p>
          ...
          <ons-input type="number" name="age" value="{{.User.Age}}" modifier="underbar" placeholder="年齢" min="0" max="120" float required></ons-input>
        </p>
        <p>
          <ons-select class="select" name="gender" id="gender" modifier="underbar" float required>
        ...
        <p>
          <ons-select class="select" name="marital" id="marital" modifier="underbar" float required>
            <select class="select-input">
              <option>未婚</option>
              <option>既婚</option>
            </select>
        ...
        <p>
          <ons-select class="select" name="address" id="address" modifier="underbar" float required>
        ...
        <p>
          <ons-select class="select" name="job" id="job" modifier="underbar" float required>
