...
<div style="text-align: center;">
  <ons-row>
    ...
    <ons-col style="text-align: right;">
      <button class="button--cta" style="line-height: 15px; background-color: cornflowerblue;" onclick="location.href='/tv/user/show'"><i class="fas fa-comments"></i>Timeline</button>
    </ons-col>
    <ons-col style="text-align: left;">
      <button class="button--cta" style="line-height: 15px; background-color: darkorange;" onclick="location.href='/tv/user/show_review'"><i class="fas fa-user"></i>Review</button>
    </ons-col>
