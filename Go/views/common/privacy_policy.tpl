<ul class="list">
  <li class="list-header">プライバシーポリシー</li>
  <li class="list-item hint-list-dialog">
    <div class="list-item__center">
      ShiJimi（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
    </div>
  </li>
</ul>
<ul class="list">
  <li class="list-header">第1条（個人情報）</li>
  <li class="list-item hint-list-dialog">
    <div class="list-item__center">
...
<ul class="list">
  <li class="list-header">第2条（個人情報の収集方法）</li>
  <li class="list-item hint-list-dialog">
    <div class="list-item__center">
...
<ul class="list">
  <li class="list-header">第3条（個人情報を収集・利用する目的）</li>
  <li class="list-item hint-list-dialog">
    <div class="list-item__center">
      当社が個人情報を収集・利用する目的は，以下のとおりです。<br />
      ・当社サービスの提供・運営のため<br />
      ・ユーザーからのお問い合わせに回答するため（本人確認を行うことを含む）<br />
      ・ユーザーが利用中のサービスの新機能，更新情報，キャンペーン等及び当社が提供する他のサービ・スの案内のメールを送付するため<br />
...
<ul class="list">
  <li class="list-header">第4条（利用目的の変更）</li>
  <li class="list-item hint-list-dialog">
    <div class="list-item__center">
...
<ul class="list">
  <li class="list-header">第5条（個人情報の第三者提供）</li>
  <li class="list-item hint-list-dialog">
    <div class="list-item__center">
...
<ul class="list">
  <li class="list-header">第6条（個人情報の開示）</li>
  <li class="list-item hint-list-dialog">
    <div class="list-item__center">
...
<ul class="list">
  <li class="list-header">第7条（個人情報の訂正および削除）</li>
  <li class="list-item hint-list-dialog">
    <div class="list-item__center">
...
<ul class="list">
  <li class="list-header">第8条（個人情報の利用停止等）</li>
  <li class="list-item hint-list-dialog">
    <div class="list-item__center">
...
<ul class="list">
  <li class="list-header">第9条（プライバシーポリシーの変更）</li>
  <li class="list-item hint-list-dialog">
    <div class="list-item__center">
